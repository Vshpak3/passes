...
export class Migration20220624035554 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "users" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "email" varchar(255) not null, "user_name" varchar(30) not null, "full_name" varchar(50) null, "phone_number" varchar(255) null, "birthday" timestamptz(0) null, "is_kycverified" boolean null, "is_creator" boolean null);');
    this.addSql('alter table "users" add constraint "users_pkey" primary key ("id");');

    this.addSql('create table "subscription" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "subscriber_id" uuid not null, "creator_id" uuid not null, "is_active" boolean not null);');
    this.addSql('alter table "subscription" add constraint "subscription_pkey" primary key ("id");');

    this.addSql('create table "settings" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "user_id" uuid not null);');
    ...
    this.addSql('create table "post" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "user_id" uuid not null, "num_likes" int not null, "num_comments" int not null);');
    ...
    this.addSql('create table "pass" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "user_id" uuid not null);');
    this.addSql('alter table "pass" add constraint "pass_pkey" primary key ("id");');

    this.addSql('create table "comment" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "post_id" uuid not null, "commenter_id" uuid not null, "content" varchar(150) not null);');
    this.addSql('alter table "comment" add constraint "comment_pkey" primary key ("id");');

    this.addSql('alter table "subscription" add constraint "subscription_subscriber_id_foreign" foreign key ("subscriber_id") references "users" ("id") on update cascade;');
    this.addSql('alter table "subscription" add constraint "subscription_creator_id_foreign" foreign key ("creator_id") references "users" ("id") on update cascade;');

    this.addSql('alter table "settings" add constraint "settings_user_id_foreign" foreign key ("user_id") references "users" ("id") on update cascade;');
    ...
    this.addSql('alter table "pass" add constraint "pass_user_id_foreign" foreign key ("user_id") references "users" ("id") on update cascade;');
