...
export class Migration20220620195528 extends Migration {
  ...
  async down(): Promise<void> {
    ...
    this.addSql('drop table if exists "account_setting" cascade;');
  }
