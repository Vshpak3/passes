...
export function PassDtoFromJSONTyped (
  json: any,
  ...
  return {
    ...
    creatorUsername: !exists(json, 'creatorUsername')
      ? undefined
      : json['creatorUsername'],
    creatorDisplayName: !exists(json, 'creatorDisplayName')
      ? undefined
      : json['creatorDisplayName'],
