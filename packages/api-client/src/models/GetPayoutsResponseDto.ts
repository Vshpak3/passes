...
export function GetPayoutsResponseDtoFromJSON(
  json: any,
): GetPayoutsResponseDto {
  return GetPayoutsResponseDtoFromJSONTyped(json, false)
}

export function GetPayoutsResponseDtoFromJSONTyped(
  json: any,
...
export function GetPayoutsResponseDtoToJSON(
  value?: GetPayoutsResponseDto | null,
): any {
  if (value === undefined) {
    return undefined
  }
