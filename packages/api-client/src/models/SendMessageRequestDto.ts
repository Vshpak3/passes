...
export function SendMessageRequestDtoFromJSON(
  json: any,
): SendMessageRequestDto {
  return SendMessageRequestDtoFromJSONTyped(json, false)
}

export function SendMessageRequestDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    payinMethod: !exists(json, 'payinMethod')
      ? undefined
      : PayinMethodDtoFromJSON(json['payinMethod']),
    scheduledAt: !exists(json, 'scheduled_at')
      ? undefined
      : new Date(json['scheduled_at']),
  }
}

export function SendMessageRequestDtoToJSON(
  value?: SendMessageRequestDto | null,
): any {
  if (value === undefined) {
    return undefined
  }
