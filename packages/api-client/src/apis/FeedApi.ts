...
export class FeedApi extends runtime.BaseAPI {
     ...
     * Gets a users feed
     */
    async feedGetFeedRaw(requestParameters: FeedGetFeedRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<object>> {
     ...
     * Gets a users feed
     */
    async feedGetFeed(requestParameters: FeedGetFeedRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<object> {
     ...
     */
    async feedGetPostsForCreatorRaw(requestParameters: FeedGetPostsForCreatorRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<object>> {
     ...
     * Gets a list of posts for a given creator
     */
    async feedGetPostsForCreator(requestParameters: FeedGetPostsForCreatorRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<object> {
