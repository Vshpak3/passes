...
const Username = () => {
  ...
  return (
    <div className="relative h-full w-full">
      <div
        className="flex h-96 w-full  justify-center"
      ...
      >
        ...
        />
        <PurpleRightVector
          style={{ right: "0", top: "56px", position: "absolute", zIndex: 1 }}
        />
        <PurpleRightVector
          style={{
            right: "-50px",
        ...
        />
        <div
          className="flex w-full max-w-7xl place-items-center justify-center px-20"
          style={{ zIndex: 2 }}
        >
      ...
      <div
        className="tabs flex h-16 w-full justify-center"
        style={{
          background: "#1F1422",
      ...
      >
        <div
          className="flex max-w-7xl flex-1 cursor-pointer"
          style={{ zIndex: 1 }}
        >
          <a
