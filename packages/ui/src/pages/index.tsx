...
const HomePage = () => {
  ...
  const buildCreatorTypeComponent = (
    creator: {
      type: string
    },
    index: number,
      ...
      <div className="relative w-full bg-[#1A1523]">
        <div className="fade-in-bottom container pt-10">
          <header className="relative">
            ...
            <div className="relative z-10 flex flex-col items-center justify-between gap-8 rounded-xl py-8 px-10 shadow-[0px_0px_120px_0px_rgba(0,_0,_0,_0.25)_inset] backdrop-blur sm:flex-row sm:shadow-none sm:backdrop-blur-none">
              <div>
                <Image
                  src="/moment.svg"
                  aria-label="moment"
            ...
            <div className="relative hidden w-screen lg:block">
              ...
              >
                {creatorsList.map((creator, index) =>
                  buildCreatorTypeComponent(creator, index),
                )}
              </Marquee>
            </div>
