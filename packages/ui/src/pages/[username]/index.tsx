...
const mockCreator = {
  ...
  discordUsername: "AlexDrachnik",
  facebookUsername: "AlexDrachnikCreator",
  instagramUsername: "drachnik",
  tiktokUsername: "@drachnik",
  twitchUsername: "",
  twitterUsername: "drachnik",
  youtubeUsername: "AlexDrachnikFit",
  postsCount: 12,
  likes: 22900,
  isVerified: true,
  isActive: true,
