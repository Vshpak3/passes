...
const LoginPage: FC = () => {
  ...
  return (
    <div className="flex-2 h-screen bg-black">
      <div className="relative mx-auto flex h-full w-full max-w-[1440px] justify-center pt-16 md:px-4 md:pt-[104px] lg:items-center lg:justify-between lg:px-16 lg:pt-0 xl:px-[170px] 2xl:px-[200px]">
