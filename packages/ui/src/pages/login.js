...
const LoginPage = () => {
  ...
  const onSubmit = (data) => {
    onUserLogin(data?.email, data?.password)
  }
          ...
          >
            ...
            <div className="flex flex-row gap-14">
              <FormInput
                ...
                errors={errors}
              />
              <Text className="ml-1 flex cursor-pointer select-none flex-row bg-gradient-to-r from-[#598BF4] to-[#B53BEC] bg-clip-text text-transparent">
