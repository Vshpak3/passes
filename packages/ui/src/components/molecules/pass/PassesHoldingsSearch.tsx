...
export const PassSearchBar: FC<PassSearchBarProps> = ({
  ...
  <div className="ml-auto">
    <div className="relative flex items-center">
      ...
      <input
        autoComplete="off"
        className="form-input h-[51px] w-[210px] rounded-md border border-white/10 bg-[#12070E]/50 pl-11 text-white outline-none placeholder:text-[16px] placeholder:text-white/30 focus:border-white/10 focus:ring-0 md:max-w-[250px]"
        id="search-passes"
        name="search-passes"
        onChange={onChange}
