...
export const FreeMessagesLeftContainer: FC<FreeMessagesLeftContainerProps> = ({
  ...
  return (
    <div className="ml-6 flex w-5/6 min-w-[300px] max-w-xl items-center justify-between gap-[10px] rounded-b-[8px] border-b border-[#FFFF]/10 bg-gradient-to-r from-[#B52A6F33] to-[#B52A6F33]/20 py-[8px] px-6 backdrop-blur-[25px]">
