...
export const CustomDropdown = (props: any) => {
  ...
  const items = results.filter((x: any) => x.cid)
  const users = results.filter((x: any) => !x.cid)
  return (
    <div>
      <style>
        {`
...
const isChannel = (output: any) => output.cid != null

export const CustomResultItem = (props: any) => {
