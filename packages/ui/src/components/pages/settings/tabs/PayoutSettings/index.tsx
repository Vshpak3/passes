  ...
  return (
    <>
      ...
      <div className="my-8 flex flex-col gap-6 xl:flex-row">
        <div
          className={classNames(
            ...
            "flex w-full gap-2 rounded-[15px] border border-passes-dark-200 bg-[#12070E]/50 p-4 md:p-6"
          )}
        >
      ...
      <div className="my-6">
        ...
        {banks?.map((bank) => (
          <div
            className="my-6 flex flex-row gap-5 rounded-[15px] border border-passes-dark-200 bg-[#12070E]/50 p-7"
            key={bank.id}
          >
            <div className="flex basis-3/4 flex-col justify-between">
