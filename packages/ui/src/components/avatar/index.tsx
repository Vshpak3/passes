...
export const Avatar = ({
  ...
  >
    ...
    <RadixAvatar.Fallback
      className={clsx(
        'relative grid h-full w-full place-items-center overflow-hidden rounded-full border border-mauve-mauve6',
        'text-mauve-mauve11 transition-colors dark:border-mauveDark-mauve6 dark:text-mauveDark-mauve11',
