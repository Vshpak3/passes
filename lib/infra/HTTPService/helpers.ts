...
//     }
//     const hash = CryptoJS.HmacSHA256(to_sign, key);
//     const hashInBase64 = CryptoJS.enc.Base64.stringify(hash);
//     return hashInBase64;
// }
// // eslint-disable-next-line
// export const hmacRequest = (options: any, payload?: any) => {
//     const timeStamp = new Date().getTime().toString();
//     let data = '';

//     if (payload) {
//         data = JSON.stringify({ ...payload, time_stamp: timeStamp }, null, 2);
//     }
//     const output = signString(APP_CONFIG.SECRET_KEY_HMAC, data);
//     return {
//         ...options,
//         headers: {
